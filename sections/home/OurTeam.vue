...
<template>
  <section id="team" class=" py-8 md:py-16 px-10">
    <div class="pyc-container-section mx-auto flex flex-col gap-10">
      <SectionInformation hint="Nuestro" title="Equipo">
        <p>
          El activo más valioso de nuestra organización, compuesto por más de 40
          profesionales y 25 colaboradores exclusivos.
        </p>
      </SectionInformation>
      ...
      <div class="relative pt-8">
        ...
        >
          <SwiperSlide v-for="(member, i) in team" :key="i" class="h-full flex">
            <div
      ...
      <div class="pb-4 flex justify-center">
        <ButtonBase to="/equipo"> Conócenos más </ButtonBase>
      </div>
    </div>
  </section>
</template>
