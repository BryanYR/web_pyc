...
<template>
  <section
    id="prevention"
    class="bg-white dark:bg-primary-800 py-8 md:py-16 px-10"
  >
      ...
      <div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-4 gap-4 mb-4">
          <div
            ...
            :key="item.key"
            :class="[
              'flex flex-col items-center gap-4 p-4  rounded-lg shadow-sm',
              i % 2 === 0
                ? 'bg-[#f2f2f2] dark:bg-primary-900'
          ...
          >
            <component
              ...
              :class="
                i % 2 === 0
                  ? 'w-12 h-12 md:w-16 md:h-16 text-primary-700 dark:text-white'
                  : 'w-12 h-12 md:w-16 md:h-16 text-white'
              "
            />
            <div
              class="text-sm font-medium lg:text-base text-center md:px-4"
              :class="
                i % 2 === 0 ? 'text-gray-800 dark:text-white' : 'text-white'
              "
            >
              {{ item.title }}
            </div>
